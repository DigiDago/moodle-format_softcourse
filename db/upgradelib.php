...
function format_softcourse_upgrade_remove_numsections() {
    ...
    $params = ['format1' => 'softcourse', 'format2' => 'softcourse', 'numsections' => 'numsections'];
    ...
    foreach ($needfixing as $courseid => $numsections) {
        format_softcourse_upgrade_hide_extra_sections($courseid, $numsections);
    }

    $DB->delete_records('course_format_options', ['format' => 'softcourse', 'sectionid' => 0, 'name' => 'numsections']);
}
 ...
 */
function format_softcourse_upgrade_hide_extra_sections($courseid, $numsections) {
    global $DB;
