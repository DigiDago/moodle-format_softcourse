@format @format_softcourse
Feature: Sections can be edited and deleted in softcourse format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete softcourse
  ...
  @javascript
  Scenario: Inline edit section name in softcourse format
  ...
  Scenario: Deleting the last section in softcourse format
  ...
  Scenario: Deleting the middle section in softcourse format
